...
With the purchase of a jukebox from TouchTunes, independent operators enter into an automatically renewing 5-year contract with the Company that provides access to the library of licensed songs, technical support, and fleet monitoring services in return for approximately 20.0% of the revenue ("coinage") generated by the jukebox ("Music Service Revenue" or "MSR"). The remaining 80.0% of gross coinage is shared between the operator and the bar/restaurant owner. 

The Company's high margin, low risk, asset-lite business model focuses on manufacturing jukeboxes through a third party (Flextronics) and selling the jukeboxes to independent operators and distributors (who will in turn sell to independent operators). These independent operators ultimately own the jukeboxes and therefore take the capital risk of whether a jukebox is successful in generating revenue. Independent operators are responsible for installing, repairing, and maintaining the jukeboxes at the various venues, effectively providing the Company with ~10,000 technical employees that do not burden the Company's operating expenses. 

TouchTunes has long and successful relationships with a network of over 2,500 independent operators with average length of relationships at over seven years. With the Company's dominant market share in North America, the majority of the Company's revenue (~77.2%) is comprised of high margin MSR while the remainder is from (~15.1%) hardware sales and (~7.7%) other domestic services sales.`
  },
  {
